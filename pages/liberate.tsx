...
function liberate() {
  ...
  return (
    <div className="bg-libera-1 h-screen">
      <Head>
        <title>Libera femina - liberate</title>
      </Head>
      <meta
        name="description"
      ...
      <div className="flex flex-row">
        <div className="h-[90vh] w-[100%] nm:w-[55%] flex items-center justify-center flex-col">
          <div className="font-bold text-center flex flex-col  justify-center items-center text-[35px] nm:text-[50px] nm:ml-6 text-white">
            <h1 className="text-center leading-[40px] nm:leading-[50px]">
              Libera Femina
            </h1>
          </div>
          <div className="bg-libera-2 mt-4 nm:mt-4 h-[40vh] nm:h-[45vh] w-[70%] nm:w-[60%] nm:min-w-[300px] rounded-3xl flex flex-col items-center justify-center">
        ...
        <div className="hidden nm:flex w-[45%] max-w-[600px]">
          <Image
            alt="mint"
            src={images.libera2}
            width={500}
