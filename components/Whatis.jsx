...
function Whatis() {
  return (
    <div className="mb-10 nm:h-[60vh] bg-libera-1 px-10 nm:flex nm:flex-row">
      <div className="nm:mt-20 nm:w-[50%] nm:flex nm:flex-col nm:items-center nm:justify-center">
        ...
        <h2 className="mt-5 text-center text-[#9A2AFC] uppercase text-[15px] font-nesatho font-bold">SOBRE ESTO</h2>
