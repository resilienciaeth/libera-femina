...
function Creators() {
  return (
    <div className=" bg-libera-1 py-10">
      <div className="items-center flex flex-col justify-center">
        ...
        <p className="text-white text-center font-kanit text-[12px] nm:text-[20px] nm:w-[60%] mt-4 px-10">
        ...
        <p className="text-white text-center font-kanit text-[12px] nm:text-[20px] mt-4 px-10">
      ...
      <div className="nm:flex nm:flex-row nm:items-center nm:justify-center">
        <div className="px-[4rem] nm:px-0 mt-10">
          <div className="flex flex-col items-center py-4">
            <div>
              <Image src={images.ka} width={363} height={467} />
            </div>
            <div className="mt-4 flex flex-col justify-start">
              <div className="flex flex-col justify-start items-center">
                <h1 className="text-left font-bold text-white font-nesatho text-[18px]">KA LARRAZA</h1>
                <p className="text-white opacity-[0.5] nm:w-[50%] text-center font-kanit text-[12px]">
        ...
        <div className="px-[4rem] nm:px-0 mt-10">
          <div className="flex flex-col items-center py-4">
            <div>
              <Image src={images.malicia} width={363} height={467} />
            </div>
            <div className="mt-4 flex flex-col justify-start">
              <div className="flex flex-col justify-start items-center">
                <h1 className="text-left font-bold text-white font-nesatho text-[18px]">DOC MALICIA</h1>
                <p className="text-white opacity-[0.5] nm:w-[52%] text-center font-kanit text-[12px]">
